...
# COMO MUDAR O PROMPT
#
#   1. rode `p10k configure` e responda o assistente — ele escreve em
#      ~/.p10k.zsh, que NÃO é este arquivo e não é gerenciado pelo Nix;
#   2. copie o resultado por cima daqui:
#
